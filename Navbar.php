  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link <?= $nav == "home" ? "active" : "" ?>" aria-current="page" href="index.php">Home</a>
        </li>
        <li class="nav-item">
      ...
      <?php else : ?>
        <div class="dropdown">
          <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img src="<?= empty($user['profile_image']) ? "./assets/images/profile.png" : './uploads/profiles/' . $user['profile_image'] ?>" class="img-profile rounded-circle" alt="User Profile">
            <?= $_SESSION['username'] ?>
          </button>
          <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
            <h4 class="dropdown-header"><?= ucfirst($_SESSION['type']) ?></h4>
            ...
            <?php if (isset($_SESSION['type']) && $_SESSION['type'] == 'teacher') : ?>
              <a class="dropdown-item" href="./dashboard/courses.php">Courses</a>
            <?php endif; ?>
